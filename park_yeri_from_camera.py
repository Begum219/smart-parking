...
class ParkingCoordinateTool:
    ...
    def run(self):
        ...
        print("\n" + "="*60)
        print("PARK YERİ KOORDİNAT BELİRLEME ARACI (Kamera Frame'i)")
        print("="*60)
        print("\nKULLANIM:")
...
if __name__ == "__main__":
    # Kameradan çekilen frame'i kullan
    IMAGE_PATH = "parking_frame.jpg"
    
    if not Path(IMAGE_PATH).exists():
        print(f"❌ '{IMAGE_PATH}' bulunamadı!")
        print("\nÖnce kameradan frame çek:")
        print("1. python parking_detector_final.py çalıştır")
        print("2. SPACE tuşuna bas")
        print("3. parking_frame.jpg oluşacak")
        print("4. Sonra bunu çalıştır")
    else:
