...
class MultiCameraParkingCoordinateTool:
    ...
    def draw_current_state(self):
        ...
        info_text = [
            ...
            f"KAYDEDİLEN: {len(self.parking_spaces)} | ŞU AN: {self.current_space_name}",
            "SOL TIK: Nokta ekle | SAĞ TIK: Kaydet | S: Bitir ve sonraki kameraya geç | ESC: Çıkış"
        ]
    ...
    def run(self):
        ...
        print("  • SAĞ TIK: Park yerini kaydet (min 3 nokta)")
        ...
        while True:
            ...
            if key == 27:  # ESC
                ...
                break  # ⬅️ Pencereyi kapat ve çık
            elif key == ord(' '):
                if len(self.current_polygon) > 0:
                    self.current_polygon = []
